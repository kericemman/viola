...
const OrganizationalDevelopment = () => {
  ...
  const service = {
    ...
    overview:
      "Structured support for organizations navigating growth, transformation, or complex change. This service helps build organizational capacity, align systems and culture, and guide teams through transitions with clarity and confidence.",
    scope: [
      "Organizational assessment and diagnostic",
      "Change readiness and impact analysis",
      ...
      "Post-implementation review and sustainment"
    ],
    deliverables: [
      "Organizational development assessment report",
      "Change management strategy and roadmap",
      "Stakeholder analysis and engagement plan",
      "Communication framework and messaging",
      "Team alignment workshop facilitation",
      "Progress metrics and evaluation framework",
      "Sustainment and reinforcement recommendations"
    ],
    outcome:
      "Stronger organizational capacity, successful change adoption, and teams that are aligned, engaged, and ready for what's next.",
    idealFor: [
      "Organizations undergoing significant change",
      "Companies scaling or restructuring",
      "Teams facing culture or alignment challenges",
      "Organizations implementing new systems or processes",
      "Businesses preparing for mergers or acquisitions"
    ],
    duration: "Custome (Project Based)",
    approach: "Collaborative, systems-oriented, and tailored to your organization's unique context and change journey"
  };

  const benefits = [
    {
      icon: <GitBranch className="w-6 h-6" />,
      title: "Structured Change Process",
      description: "Navigate complex transitions with clarity and purpose"
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Team Alignment",
      description: "Build shared understanding and commitment across the organization"
    },
    {
      icon: <RefreshCw className="w-6 h-6" />,
      title: "Sustainable Transformation",
      description: "Create lasting change that sticks beyond initial implementation"
    },
    {
      icon: <BarChart3 className="w-6 h-6" />,
      title: "Measurable Progress",
      description: "Track and evaluate change adoption and organizational impact"
    }
  ];

  const developmentAreas = [
    {
      area: "Organizational Assessment",
      items: ["Diagnostic and gap analysis", "Culture and climate assessment", "Systems and process review", "Capacity evaluation"]
    },
    {
      area: "Change Strategy",
      items: ["Change readiness assessment", "Impact analysis", "Stakeholder mapping", "Communication planning"]
    },
    {
      area: "Team Development",
      items: ["Team effectiveness workshops", "Role clarity and alignment", "Collaboration frameworks", "Conflict resolution"]
    },
    {
      area: "Process Improvement",
      items: ["Workflow optimization", "Decision-making processes", "Cross-functional coordination", "System integration"]
    },
    {
      area: "Culture Transformation",
      items: ["Values alignment", "Behavioral norms", "Leadership modeling", "Culture measurement"]
    },
    {
      area: "Sustainment",
      items: ["Reinforcement mechanisms", "Progress tracking", "Adaptive management", "Continuous improvement"]
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Comprehensive assessment of organizational needs, change readiness, and development opportunities.",
      icon: <Target className="w-6 h-6" />
    },
    {
      step: 2,
      title: "Strategy & Design",
      description: "Co-create a tailored organizational development and change management strategy with clear milestones.",
      icon: <Puzzle className="w-6 h-6" />
    },
    {
      step: 3,
      title: "Implementation & Engagement",
      description: "Guide the organization through implementation, facilitating key engagements and building capability.",
      icon: <Users className="w-6 h-6" />
    },
    {
      step: 4,
      title: "Review & Sustainment",
      description: "Evaluate progress, reinforce changes, and embed new capabilities for lasting impact.",
      icon: <RefreshCw className="w-6 h-6" />
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                ...
                >
                  <RefreshCw className="w-5 h-5 mb-2" style={{ color: "#B3785A" }} />
                  <p className="text-sm font-medium" style={{ color: "#748DB0" }}>Focus</p>
                  <p className="text-sm font-semibold" style={{ color: "#194C63" }}>Change Management</p>
                </div>
              </div>
            ...
            <div className="relative">
              ...
              >
                <img 
                  src="/assets/5.jpg"
                  alt="Organizational Development & Change Management"
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-xs font-medium" style={{ color: "#194C63" }}>Change success</span>
                </div>
                <p className="text-2xl font-bold" style={{ color: "#194C63" }}>85%</p>
                <p className="text-xs" style={{ color: "#748DB0" }}>Adoption rate</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              style={{ color: "#3C637B" }}
            >
              Build the capacity and alignment needed to thrive through change and growth
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              style={{ color: "#3C637B" }}
            >
              Comprehensive support for organizational growth and transformation
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="relative">
              <img 
                src="/assets/12.jpg"
                alt="Organizational Development Workshop"
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm mt-1" style={{ color: "#3C637B" }}>
                    For: Organizational Development & Change Management
                  </p>
                </div>
                <button
                  onClick={() => {
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="What organizational development or change challenges are you facing?"
                    required
                    rows="3"
                    disabled={isSubmitting || submitStatus === 'success'}
                    className="w-full p-3 rounded focus:outline-none focus:ring-2 transition-all disabled:opacity-50"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="What do you hope to achieve through this engagement?"
                    required
                    rows="3"
                    disabled={isSubmitting || submitStatus === 'success'}
                    className="w-full p-3 rounded focus:outline-none focus:ring-2 transition-all disabled:opacity-50"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="e.g., Next 6 months, Phased approach"
                    disabled={isSubmitting || submitStatus === 'success'}
                    className="w-full p-3 rounded focus:outline-none focus:ring-2 transition-all disabled:opacity-50"
                    style={{
                      backgroundColor: "#F5FAFD",
