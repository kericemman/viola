...
const RecruitmentAdvisory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const inquiryData = {
        serviceId: "recruitment-advisory",
  ...
  const service = {
    id: "recruitment-advisory",
    title: "Recruitment & Talent Acquisition Advisory",
    overview:
      "Strategic support to help organizations attract, assess, and secure the right talent. This advisory service moves beyond reactive hiring to build sustainable recruitment systems that align with your organization's growth trajectory and cultural values.",
    scope: [
      "Workforce planning and role definition",
      "Candidate sourcing strategy development",
      "Interview process design and assessment tools",
      "Selection criteria and decision frameworks",
      "Offer management and negotiation support",
      "Onboarding program design",
      "Recruitment metrics and tracking systems",
      "Employer branding and candidate experience"
    ],
    deliverables: [
      "Workforce plan with role prioritization",
      "Customized recruitment process map",
      "Interview guides and assessment templates",
      "Candidate scorecards and evaluation tools",
      "Onboarding framework and checklist",
      "Recruitment tracking system recommendations"
    ],
    outcome:
      "A structured, efficient recruitment process that consistently attracts qualified candidates, reduces time-to-hire, and ensures better role-person-organization fit.",
    idealFor: [
      "Organizations scaling their teams",
      "Companies struggling with hiring consistency",
      "Businesses entering new markets or sectors",
      "Organizations seeking to improve candidate quality",
      "Startups building their first hiring processes"
    ],
    duration: "(Initial framework, with ongoing support options)",
    approach: "Collaborative, practical, and tailored to your organization's culture, industry, and growth stage"
  };
  ...
  const benefits = [
    {
      ...
      description: "Align hiring with organizational goals and growth projections"
    },
    {
      icon: <UserPlus className="w-6 h-6" />,
      title: "Better Candidate Quality",
      description: "Attract and select candidates who truly fit your needs and culture"
    },
    {
      icon: <TrendingUp className="w-6 h-6" />,
      title: "Reduced Time-to-Hire",
      description: "Streamlined processes that move candidates efficiently through the pipeline"
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Consistent Evaluation",
      description: "Fair, structured assessment that reduces bias and improves decisions"
    }
  ];
  ...
  const recruitmentAreas = [
    {
      ...
      items: ["Role analysis and definition", "Headcount planning", "Skills gap assessment", "Hiring timeline development"]
    },
    {
      area: "Sourcing Strategy",
      items: ["Candidate channel identification", "Job description optimization", "Employer branding", "Passive candidate engagement"]
    },
    {
      area: "Selection Process",
      items: ["Interview structure design", "Assessment tool development", "Candidate scorecards", "Decision-making frameworks"]
    },
    {
      area: "Candidate Experience",
      items: ["Communication protocols", "Application process review", "Feedback mechanisms", "Offer and negotiation support"]
    },
    {
      area: "Onboarding & Integration",
      items: ["Onboarding program design", "Role integration planning", "Early tenure support", "Performance ramp-up"]
    },
    {
      area: "Metrics & Improvement",
      items: ["Recruitment KPIs", "Process tracking", "Quality of hire measurement", "Continuous improvement"]
    }
  ];
  ...
  const process = [
    {
      ...
      description: "Collaborate to understand your organization's talent needs, define role requirements, and establish hiring priorities.",
      icon: <BarChart className="w-6 h-6" />
    },
    {
      step: 2,
      title: "Sourcing Strategy Development",
      description: "Design effective sourcing approaches to attract qualified candidates through multiple channels.",
      icon: <Search className="w-6 h-6" />
    },
    {
      step: 3,
      title: "Selection Framework Design",
      description: "Create structured interview processes, assessment tools, and evaluation criteria for consistent decision-making.",
      icon: <Filter className="w-6 h-6" />
    },
    {
      step: 4,
      title: "Implementation Support",
      description: "Provide guidance as you implement new processes, train hiring teams, and refine approaches based on results.",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              >
                <img 
                  src="/assets/6.jpg"
                  alt="Recruitment & Talent Acquisition Advisory"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              style={{ color: "#3C637B" }}
            >
              Build hiring systems that attract, assess, and secure the right talent
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              style={{ color: "#3C637B" }}
            >
              Comprehensive support across the entire talent acquisition lifecycle
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="relative">
              <img 
                src="/assets/11.jpg"
                alt="Recruitment Strategy Session"
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm mt-1" style={{ color: "#3C637B" }}>
                    For: Recruitment & Talent Acquisition Advisory
                  </p>
                </div>
                <button
                  onClick={() => {
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="What recruitment or talent challenges are you facing?"
                    required
                    rows="3"
                    disabled={isSubmitting || submitStatus === 'success'}
                    className="w-full p-3 rounded focus:outline-none focus:ring-2 transition-all disabled:opacity-50"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="e.g., Next quarter, Within 2 months"
                    disabled={isSubmitting || submitStatus === 'success'}
                    className="w-full p-3 rounded focus:outline-none focus:ring-2 transition-all disabled:opacity-50"
                    style={{
                      backgroundColor: "#F5FAFD",
