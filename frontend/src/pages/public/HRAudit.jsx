...
const HRAuditCompliance = () => {
  ...
  const service = {
    ...
    overview:
      "A comprehensive review of your organization's HR practices, policies, and documentation to identify risks, ensure compliance with labor laws, and strengthen internal systems. This service helps organizations mitigate legal exposure while building a foundation for sound people management.",
    scope: [
      "Review of HR policies and employee handbooks",
      "Employment contracts and legal compliance check",
      "Payroll and benefits administration review",
      "Personnel file audit and record-keeping assessment",
      "Leave management and attendance tracking systems",
      "Performance management process evaluation",
      "Termination and offboarding procedures review",
      "Labor law compliance gap analysis"
    ],
    deliverables: [
      "Comprehensive HR audit report with findings",
      "Risk assessment and compliance gap analysis",
      "Prioritized remediation recommendations",
      "Updated policy templates and contract samples",
      "Implementation action plan with timeline",
      "Compliance checklist for ongoing reference"
    ],
    outcome:
      "Reduced legal risk, confidence in HR compliance, and strengthened internal systems that protect both the organization and its people.",
    idealFor: [
      "Organizations preparing for growth or funding",
      "Companies with outdated HR practices",
      "Businesses entering new regulatory environments",
      "Organizations recovering from compliance issues",
      "Any organization seeking to minimize legal risk"
    ],
    duration: "4-8 weeks (depending on organization size and complexity)",
    approach: "Thorough, practical, and focused on actionable recommendations that balance compliance with operational reality"
  };
  ...
  const benefits = [
    {
      ...
      description: "Identify and address compliance gaps before they become legal issues"
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Legal Protection",
      description: "Ensure your practices align with current labor laws and regulations"
    },
    {
      icon: <FileCheck className="w-6 h-6" />,
      title: "Documentation Integrity",
      description: "Establish proper record-keeping and personnel file management"
    },
    {
      icon: <TrendingUp className="w-6 h-6" />,
      title: "Operational Confidence",
      description: "Build HR systems that support sustainable organizational growth"
    }
  ];

  const auditAreas = [
    {
      area: "Policies & Documentation",
      items: ["Employee handbook review", "Policy gap analysis", "Handbook accessibility", "Policy communication"]
    },
    {
  ...
  const process = [
    {
      ...
      description: "Gather and review all existing HR documentation, policies, contracts, and personnel records.",
      icon: <FileText className="w-6 h-6" />
    },
    {
      step: 2,
      title: "Systems & Practices Assessment",
      description: "Evaluate current HR processes, including recruitment, onboarding, performance management, and offboarding.",
      icon: <ClipboardCheck className="w-6 h-6" />
    },
    {
      step: 3,
      title: "Compliance Gap Analysis",
      description: "Compare current practices against legal requirements and industry standards to identify risks and gaps.",
      icon: <Gavel className="w-6 h-6" />
    },
    {
      step: 4,
      title: "Reporting & Recommendations",
      description: "Deliver comprehensive audit findings with prioritized, actionable recommendations for remediation.",
      icon: <FileCheck className="w-6 h-6" />
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                ...
                >
                  <Shield className="w-5 h-5 mb-2" style={{ color: "#B3785A" }} />
                  <p className="text-sm font-medium" style={{ color: "#748DB0" }}>Focus</p>
                  <p className="text-sm font-semibold" style={{ color: "#194C63" }}>Compliance & Risk</p>
                </div>
              </div>
            ...
            <div className="relative">
              ...
              >
                <img 
                  src="/assets/1.jpg"
                  alt="HR Audit & Compliance Review"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              style={{ color: "#3C637B" }}
            >
              Protect your organization, strengthen your systems, and build confidence in your people practices
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p 
              ...
              style={{ color: "#3C637B" }}
            >
              A comprehensive examination of your HR systems and practices
            </p>
          </div>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm mt-1" style={{ color: "#3C637B" }}>
                    For: HR Audit & Compliance Review
                  </p>
                </div>
                <button
                  onClick={() => {
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="What HR or compliance challenges are you facing?"
                    required
                    rows="3"
                    disabled={isSubmitting || submitStatus === 'success'}
                    className="w-full p-3 rounded focus:outline-none focus:ring-2 transition-all disabled:opacity-50"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    placeholder="What do you hope to achieve through this audit?"
                    required
                    rows="3"
                    disabled={isSubmitting || submitStatus === 'success'}
                    className="w-full p-3 rounded focus:outline-none focus:ring-2 transition-all disabled:opacity-50"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="e.g., Within 3 months, Next quarter"
                    disabled={isSubmitting || submitStatus === 'success'}
                    className="w-full p-3 rounded focus:outline-none focus:ring-2 transition-all disabled:opacity-50"
                    style={{
                      backgroundColor: "#F5FAFD",
...
export default HRAuditCompliance;